...
var jscolor = {
	...
	getElementPos : function(e) {
		var e1=e, e2=e;
		var x=-26, y=0; //-26 pour correspondre avec le bouton A
		if(e1.offsetParent) {
			do {
				x += e1.offsetLeft;
				y += e1.offsetTop;
	...
	color : function(target, idText) {
		...
		this.pickerButtonHeight = 10; // px
		this.pickerClosable = true;
		this.pickerCloseText = 'Valider';
		...
		function drawPicker(x, y) {
			...
			p.btn.style.bottom = THIS.pickerFace-3 + 'px';
			p.btn.style.padding = '0 40px';
			...
			p.btn.onmouseup = function () {
				THIS.hidePicker();
				addColor(THIS.idText);
			};
